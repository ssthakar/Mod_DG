	...
	for(int j=0;j<mesh1.ntype;j++)  //loop over all the edges of the cell 
	{
		switch(j)
		{
			case 0:
			{
				...
				std::cout<<"case 0 denom: "<<denom<<std::endl;
				break;
			}
			case 1:
			{
				...
				print2Term(Ui);
				std::cout<<"case 1 denom: "<<denom<<std::endl;
				break;
			}
			case 2:
			{
...
{
	std::cout<<"outer RK called"<<std::endl;
	int iter_count = 0;
...
void ddt::RK3::RK_s1(grid::mesh &mesh1) //this also serves forward euler
{
	...
	std::cout<<"contribution complete"<<std::endl;
...
void DG::delta_T(grid::mesh &mesh1)
{
	...
	std::cout<<"LTS push backs to geoel done"<<std::endl;
}
